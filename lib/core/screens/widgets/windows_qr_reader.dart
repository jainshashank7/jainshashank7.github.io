...
class WindowQRcodeScanner extends StatelessWidget {
  ...
  Future<bool> initPlatformState(
    ...
    try {
      ...
      print(getAssetFileUrl(asset: PackageConstant.barcodeFilePath));
      print("This is the Controller URL :: ${controller.url.toString()}");
